...
>
  ...
  <div className="flex items-center gap-3">
    ...
    >
      ...
      {/* MOBILE MENU */}
    <div
  className={`fixed left-0 right-0 top-[72px] z-40 flex flex-col gap-1 overflow-hidden bg-[var(--navy)] px-6 transition-all duration-300 lg:hidden ${
    menuOpen
...
>
  ...
  <div className="relative z-[2] mx-auto w-[92%] max-w-[1200px]">
    ...
    >
      ...
      Meets
      <br />
      <em className="italic text-[var(--gold-light)]">Comfort</em>
    </h1>
