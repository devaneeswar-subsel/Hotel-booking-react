...
export default function RoomDetail({
 ...
 useEffect(() => {
  ...
  const policies = [
    { icon: <IconClock />, text: "Check In & Check Out time is 24 hours." },
    { icon: <IconCheck />, text: "50% advance payment for confirmation, balance amount to be paid on or before arrival." },
    { icon: <IconCheck />, text: "Taxes as applicable." },
    { icon: <IconCheck />, text: "Child policy: Below 8 years-Complimentary, 9 to 12 Years-Child policy, 12 Years & above- Adult." },
    { icon: <IconCheck />, text: "Accordingly, to government regulations, a valid Photo ID has to be carried by every person above the age of 18. The identification proofs accepted are Driver’s License, Voters Card, Passport & Aadhar card." },
    { icon: <IconCheck />, text: "The amount paid for room does not include charges for optional services and facilities (such as lunch, dinner, snacks and etc.,) These will be charged at the time of check-out from the Hotel." },
    { icon: <IconX />, text: "We do not allow unmarried / unrelated couples to check-in. This is at the full discretion of the hotel management. No refund would be applicable in case the hotel denies check-in under such circumstances." },
    { icon: <IconSmoke />, text: "Smoking & Alcoholic Beverages strictly prohibited inside our hotel premises." },
    { icon: <IconX />, text: "Usage of electrical items other than facilities provided by residency is strictly prohibited." },
    { icon: <IconCheck />, text: "In the Hotel Premises please refrain from gambling or any conduct corrupting public morals and safety or any speech which may cause an annoyance to other Guests." },
    { icon: <IconCheck />, text: "Cancellation Policy / No Show: In case of cancellation / amendment a mail / written notice must be received by the hotel at least 03 days prior to the date of arrival or else retention charges will be applicable for all the booked room nights." },
    { icon: <IconCheck />, text: "Retention charge of total booked room nights will be applicable if the guest does not check in on the designated date of arrival." },
    { icon: <IconCheck />, text: "The Hotel reserves the right to change/amend the above policy from time to time." },
    { icon: <IconCheck />, text: "Payment options: Cash / credit / debit cards / Razor pay / Mobile banking." },
    { icon: <IconCoffee />, text: "Complimentary breakfast is available from 7.30am to 10.00am." },
  ];
