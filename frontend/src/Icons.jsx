...
export const StarIcon = (p) => (
  <Icon {...p} fill={p.filled ? "currentColor" : "none"}>
...
export const DumbbellIcon = (p) => (
  <Icon {...p}>
    ...
    <path d="M8 8L5.5 5.5a2.12 2.12 0 00-3 3l8 8a2.12 2.12 0 003-3L11 11" />
    <path d="M14.5 9.5l-1-1 2.5-2.5 1 1" />
    <path d="M9.5 14.5l-1-1-2.5 2.5 1 1" />
  </Icon>
);
...
export const SwimmingIcon = (p) => (
  <Icon {...p}>
    <path d="M2 12h3l2-4 3 8 2-4 3 4h7" />
...
export function VehicleIcon({ size = 16, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
